...
extension SelectTeamViewController: IViewModelableController {
...
extension SelectTeamViewController {
    ...
    private func sendNotification(image: UIImage, name: String) {
        ...
        AddMatchRouter.popViewController(in: navigationController)
    }
...
extension SelectTeamViewController: UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
...
struct SelectTeamViewControllerProvider: PreviewProvider {
    ...
    struct ContainerView: UIViewControllerRepresentable {
        let selectTeamViewController = SelectTeamViewController()
        
        func makeUIViewController(context: UIViewControllerRepresentableContext<SelectTeamViewControllerProvider.ContainerView>) -> SelectTeamViewController {
            return selectTeamViewController
        }

        func updateUIViewController(_ uiViewController: SelectTeamViewControllerProvider.ContainerView.UIViewControllerType, context: UIViewControllerRepresentableContext<SelectTeamViewControllerProvider.ContainerView>) {
        }
    }
}
